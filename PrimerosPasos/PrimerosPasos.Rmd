---
title: "Primeros pasos para aprender a Iterar"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
* Calcula el logaritmo del número. Luego hace click en _Submit Answer_ (_Enviar respuesta_ en Inglés).
...
* Hacé clic en  _Submit Answer_ para probarlo. ¡Vale la pena verlo al menos una vez! 
...
```{r vectors-check}
"La vectorización en R funciona, pero hay algo más que tienes que saber. Hacé clic en Continue para averiguar qué es."
```
...
* Intenta ejecutar `log()` en la siguiente lista para averiguarlo. Haga clic en _Run Code_.
...
```{r lists-hint}
"solo haz clic en Run Code para ver que pasa."
```
...
* Termina el siguiente código para tomar el registro de cada valor en `list1`. Luego haga clic en _Submit Answer_.
